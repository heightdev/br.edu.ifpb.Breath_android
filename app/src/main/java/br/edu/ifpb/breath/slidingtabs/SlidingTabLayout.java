...
package br.edu.ifpb.breath.slidingtabs;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int TAB_VIEW_ICON_SIZE_DIPS = 35;
    private static final int TAB_VIEW_ICON_PADDING_DIPS = 8;
    ...
    private HashMap<Integer, Drawable> mIcons = new HashMap<Integer, Drawable>();
    private boolean mUseIcons = false;
    ...
    protected View createDefaultTabView(Context context, int type) {
        if(type == 0) {
            ...
            iconView.setLayoutParams(new LinearLayout.LayoutParams(
                    iconSize + padding, iconSize + padding));
    ...
    public void setIcon(int pos, Drawable icon){
        mIcons.put(pos, icon);
    }

    public void removeIcon(int pos){
        if(mIcons.containsKey(pos))
            mIcons.remove(pos);
    }
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                ...
                child.setAlpha(position == i? 1.0f : 0.25f);
            }
            if (mViewPagerPageChangeListener != null) {
